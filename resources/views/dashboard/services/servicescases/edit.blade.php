     ...
     <div class="card card-custom card-sticky" id="kt_page_sticky_card" style="align-item:center"> 
        <div class="card-header" style="">
	        <div class="card-title">
			    ...
			    <i class="mr-2"></i>
		        <small class="">Your case </small></h3>
			</div>									
                            ...
                            <div class="my-5">
                                ...
                                {{-- Start short story  --}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                        <textarea class="form-control @error('short_story_en') is-invalid @enderror"  cols="20" rows="10" name="short_story_en" required validate>{{$items->short_story_en}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                        <textarea class="form-control @error('short_story_nl') is-invalid @enderror"  cols="20" rows="10" name="short_story_nl" required validate>{{$items->short_story_nl}}</textarea>
                                ...
                                {{-- Start Initial problem --}}
                                    ...
                                    <div class="form-group row">
                                        <label class="col-3">English</label>
                                        <div class="col-9">
                                        <textarea class="form-control @error('initial_problem_en') is-invalid @enderror"  cols="20" rows="10" name="initial_problem_en" required validate>{{$items->initial_problem_en}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-3">Nederlands</label>
                                        <div class="col-9">
                                        <textarea class="form-control @error('initial_problem_nl') is-invalid @enderror"  cols="20" rows="10" name="initial_problem_nl" required validate>{{$items->initial_problem_nl}}</textarea>
                                ...
                                {{-- Start Details --}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                        <input class="form-control @error('cost') is-invalid @enderror" value="{{$items->cost}}" name="cost" id="" required validate/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <select name="doctor_id" id="" value="{{$items->doctor_id}}" class="form-control @error('doctor_id') is-invalid @enderror" required validate>
