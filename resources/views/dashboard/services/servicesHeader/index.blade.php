                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Sevices Header
                                            <div class="text-muted pt-2 font-size-sm">Cusomize Services page Header screen</div></h3>
                                        </div>
                                                   ...
                                                   @if(isset($items))
                                                    @foreach ($items as $value)
                                                        <tr>
                                                            ...
                                                            <td > @if($value->imagePath !="")<img style="width:70px; height:45px;" src="{{asset('/storage/services/'.$value->imagePath)}}" alt="" >@endif</td>
                                                            <td>
