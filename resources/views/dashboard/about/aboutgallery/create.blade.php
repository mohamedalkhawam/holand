     ...
     <div class="card card-custom card-sticky" id="kt_page_sticky_card" style="align-item:center"> 
        <div class="card-header" style="">
            ...
            <div class="card-toolbar">
                <a href="{{route('dashboard.about.gallery.index')}}" class="btn btn-light-primary font-weight-bolder mr-2">
        ...
        <div class="card-body">
        <form class="form"action="{{route('dashboard.about.gallery.store')}}" method="post"  enctype="multipart/form-data" id="editForm">
