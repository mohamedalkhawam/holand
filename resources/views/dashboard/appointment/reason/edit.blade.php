     ...
     <div class="card card-custom card-sticky" id="kt_page_sticky_card" style="align-item:center"> 
        <div class="card-header" style="">
	        <div class="card-title">
				<h3 class="card-label">Create Reasons
			    <i class="mr-2"></i>
		        <small class=""> you can replace the old value with the new value.</small></h3>
			</div>									
            <div class="card-toolbar">
                <a href="{{route('dashboard.appointment.reason.index')}}" class="btn btn-light-primary font-weight-bolder mr-2">
        ...
        <div class="card-body">
        <form class="form"action="{{route('dashboard.appointment.reason.update',$items->id)}}" method="post"  enctype="multipart/form-data" id="editForm">
