                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                       ...
                                       <div class="d-flex align-items-center" >
                                            <a href=" {{route('dashboard.appointment.reason.create')}} "class="btn btn-primary" style="font-weight:600">Create Service</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <!--begin: Search Form-->
                                            ...
                                            @if(isset($items))
                                                @foreach ($items as $value)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href=" {{route('dashboard.appointment.reason.edit',$value->id)}} " >
                                                                     ...
                                                                     <a href="javaScript:void(0)"  style="margin-left:5px;" onclick="$(this).parent().find('form').submit()">
                                                                        <form action="{{Route('dashboard.appointment.reason.destroy',$value->id)}}" method="post" style="display: none">
                                                                            @method('DELETE')
