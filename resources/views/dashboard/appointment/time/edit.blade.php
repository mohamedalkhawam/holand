     ...
     <div class="card card-custom card-sticky" id="kt_page_sticky_card" style="align-item:center"> 
        <div class="card-header" style="">
	        <div class="card-title">
				<h3 class="card-label">Edit working hours
			    <i class="mr-2"></i>
		        <small class=""> you can replace the old value with the new value.</small></h3>
			</div>									
            <div class="card-toolbar">
                <a href="{{route('dashboard.appointment.time.index')}}" class="btn btn-light-primary font-weight-bolder mr-2">
        ...
        <div class="card-body">
        <form class="form"action="{{route('dashboard.appointment.time.update',$items->id)}}" method="post"  enctype="multipart/form-data" id="editForm">
                        ...
                        <div class="col-xl-8">
                            <div class="my-5">
                                {{-- Start Title --}}
                                    ...
                                    <h3 class="text-dark font-weight-bold mb-10">Costumize Hours and thier state: </h3>
