...
{{-- <div class="login-form login-signup pt-11">
                        <!--begin::Form-->
                        <form class="form" validate="validate" id="kt_login_signup_form" method="POST" action="{{route('register')}}">
                            <!--begin::Title-->
                            @csrf
                            <div class="text-center pb-8">
                                <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{{ __('Register') }}/h2>
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="Fullname" id ="name" autocomplete="off" name="name" value="{{ old('name') }}" required autofocus/>
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <!--begin::Form group-->
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="email"  id="email" placeholder="Email" name="email" autocomplete="off" alue="{{ old('email') }}" required/>
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
